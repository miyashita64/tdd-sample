...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/home/taki/etrobo/scripts/git" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/home/taki/etrobo/scripts/git" show-ref "main"
  WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/home/taki/etrobo/scripts/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/home/taki/etrobo/scripts/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/home/taki/etrobo/scripts/git" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
...
execute_process(
  COMMAND "/home/taki/etrobo/scripts/git" status --porcelain
  WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/home/taki/etrobo/scripts/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/home/taki/etrobo/scripts/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/home/taki/etrobo/scripts/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/home/taki/etrobo/scripts/git" rebase --abort
      WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/home/taki/etrobo/scripts/git" stash pop --index --quiet
          WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src'."
    ...
    execute_process(
      COMMAND "/home/taki/etrobo/scripts/git" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/home/taki/etrobo/scripts/git" reset --hard --quiet
      WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
    )
    execute_process(
      COMMAND "/home/taki/etrobo/scripts/git" stash pop --quiet
      WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/home/taki/etrobo/scripts/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src"
      )
      execute_process(
        COMMAND "/home/taki/etrobo/scripts/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/taki/windows/CATdd/target_project/tdd-sample/build/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
